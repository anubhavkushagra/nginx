...
int main(int argc, char** argv) {
    ...
    auto main_channel = grpc::CreateCustomChannel("192.168.0.211:443", grpc::SslCredentials(ssl_opts), args);
    ...
    for (int i = 0; i < threads; i++) {
        // Change from localhost to AMD NGINX Proxy IP
        std::string target_port = "192.168.0.211:443";
